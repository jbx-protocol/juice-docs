...
* `reclaimedAmount` is the [`JBTokenAmount`](/docs/dev/v3/api/data-structures/jbtokenamount.md) reclaimed from the treasury. Includes the token being reclaimed, the value, the number of decimals included, and the currency of the amount.
* `forwardedAmount` is the [`JBTokenAmount`](/docs/dev/v3/api/data-structures/jbtokenamount.md) amount reclaimed from the treasury. Includes the token being reclaimed, the value, the number of decimals included, and the currency of the amount.
