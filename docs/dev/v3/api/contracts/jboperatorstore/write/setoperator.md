...
* `_operatorData` is the [`JBOperatorData`](/docs/dev/v3/api/data-structures/jboperatordata.md) that specifies the params for the operator being set.
...
1.  Pack the provided permissions into a `uint256`. Each bit of the resulting value represents whether or not permission has been granted for that index.
    ...
    * [`_packedPermissions`](/docs/dev/v3/api/contracts/jboperatorstore/read/-_packedpermissions.md)
...
3.  Emit a `SetOperator` event with the relevant parameters.
     ...
     * [`SetOperator`](/docs/dev/v3/api/contracts/jboperatorstore/events/setoperator.md)
