...
* [`setOperator`](/docs/dev/v3/api/contracts/jboperatorstore/write/setoperator.md)
* [`setOperators`](/docs/dev/v3/api/contracts/jboperatorstore/write/setoperators.md)
