...
* Through the [`requirePermission`](/docs/dev/v3/api/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the token holder, or from an operator that has been given the [`JBOperations2.SET_ENS_NAME_FOR`](/docs/dev/v3/api/libraries/jboperations2.md) permission by the token holder.
...
3.  Emit a `SetEnsNameParts` event with the relevant parameters.
    ...
    * [`SetEnsNameParts`](/docs/dev/v3/api/contracts/or-utilities/jbprojecthandles/events/setensnameparts.md)
