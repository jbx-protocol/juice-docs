...
* Through the [`requirePermission`](/docs/dev/v3/api/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the project's owner, or from an operator that has been given the [`JBOperations.ISSUE`](/docs/dev/v3/api/libraries/jboperations.md) permission by the project owner for the provided `_projectId`.
...
4.  Deploy a new instance of a [`JBToken`](/docs/dev/v3/api/contracts/jbtoken/README.md) contract. Assign it to the return value.
...
6.  Emit an `Issue` event with the relevant parameters.
    ...
    * [`Issue`](/docs/dev/v3/api/contracts/jbtokenstore/events/issue.md)
