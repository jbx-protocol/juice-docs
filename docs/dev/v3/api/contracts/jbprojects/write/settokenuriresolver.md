...
1.  Store the new resolver.
    ...
    * [`tokenUriResolver`](/docs/dev/v3/api/contracts/jbprojects/properties/tokenuriresolver.md)
2.  Emit a `SetTokenUriResolver` event with the relevant parameters.
    ...
    * [`SetTokenUriResolver`](/docs/dev/v3/api/contracts/jbprojects/events/settokenuriresolver.md)
