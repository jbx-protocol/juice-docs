...
:::info
Visit the deprecated section for [v2 contract addresses]((/docs/dev/v2/addresses) and [v1 contract addresses]((/docs/dev/v1/resources/contract-addresses).
:::
...
[`Tickets`]((/docs/dev/v1/ticketbooth/tickets/README.md) v1 JBX: [`0x3abf2a4f8452ccc2cf7b4c1e4663147600646f66`](https://etherscan.io/token/0x3abf2a4f8452ccc2cf7b4c1e4663147600646f66)

[`JBV3Token`](/docs/dev/v3/extensions/juice-v3-migration/jbv3token.md) v3 JBX: [`0x4554CC10898f92D45378b98D6D6c2dD54c687Fb2`](https://etherscan.io/address/0x4554CC10898f92D45378b98D6D6c2dD54c687Fb2)

:::info
JBX holders but are not required to claim their JBX as the ERC-20 tokens above. For accurate balances, see the relevant [`JBTokenStore`](/docs/dev/v3/api/contracts/jbtokenstore/README.md) or [`TicketBooth`]((/docs/dev/v1/ticketbooth/README.md) contract.
:::
...
:::info
See [`juice-token-resolver`](/docs/dev/v3/extensions/juice-token-resolver/README.md) and its [git source](https://github.com/jbx-protocol/juice-token-resolver.git).
:::
