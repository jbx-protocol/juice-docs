...
1.  Get this terminal's current overflow, which is in terms of this terminal's token.
    ...
    * [`currentOverflowOf`](/docs/dev/v3/deprecated/jbsingletokenpaymentterminalstore/read/currentoverflowof.md)
...
3.  If this terminal's currency isn't ETH, convert the overflow to ETH. Return the 18 decimal ETH fixed point overflow value.
    ...
    * [`JBCurrencies`](/docs/dev/v3/api/libraries/jbcurrencies.md)
      * `.ETH`
    ...
    * [`prices`](/docs/dev/v3/deprecated/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/properties/prices.md)
