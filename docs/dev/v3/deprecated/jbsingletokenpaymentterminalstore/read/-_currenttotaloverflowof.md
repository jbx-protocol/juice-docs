...
1.  Get a reference to all of the project's current terminals.
    ...
    * [`terminalsOf`](/docs/dev/v3/api/contracts/jbdirectory/read/terminalsof.md)
...
3.  For each terminal, add its balance in terms of ETH to the total ETH balance.
    ...
    * [`currentEthOverflowOf`](/docs/dev/v3/deprecated/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/read/currentethoverflowof.md)
