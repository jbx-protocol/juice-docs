...
7.  If there are outstanding reserved tokens, distribute them to reserved token splits. Get a reference to any leftover amount after the splits are settled.
    ...
    * [`JBSplitsGroups`](/docs/dev/v3/api/libraries/jbsplitsgroups.md)
      * `.RESERVED_TOKENS`

    _Internal references:_

    * [`_distributeToReservedTokenSplitsOf`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/write/-_distributetoreservedtokensplitsof.md)
...
9.  Emit a `DistributeReservedTokens` event with the relevant parameters.
    ...
    * [`DistributeReservedTokens`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/distributereservedtokens.md)
