...
* Arguments:
  ...
  * `_projectMetadata` is a [`JBProjectMetadata`](/docs/dev/v3/api/data-structures/jbprojectmetadata.md) data structure to associate with the project within a particular domain. This can be updated any time by the owner of the project.
...
2.  Create the project. This will mint an ERC-721 in the owner's wallet representing ownership over the project.
    ...
    * [`projects`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/properties/projects.md)
...
6.  Emit a `LaunchProject` event with the relevant parameters.
    ...
    * [`LaunchProject`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/launchproject.md)
...
| Name                                                                    | Data                                                                                                                                                                                                                                                                                                                                                          |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`LaunchProject`**](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/launchproject.md)                                         | <ul><li><code>uint256 configuration</code></li><li><code>uint256 projectId</code></li><li><code>string memo</code></li><li><code>address caller</code></li></ul>                 |
