...
3.  Emit a `PrepMigration` event with the relevant parameters.
    ...
    * [`PrepMigration`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/prepmigration.md)
...
| Name                                        | Data                                                                                                                                                                                                                                                       |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`PrepMigration`**](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/prepmigration.md)                                               | <ul><li><code>uint256 projectId</code></li><li><code>[IJBController](/docs/dev/v3/interfaces/ijbcontroller.md) from</code></li><li><code>address caller</code></li></ul>                                                                                                                  |
