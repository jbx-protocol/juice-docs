...
5.  Emit a `ReconfigureFundingCycles` event with the relevant parameters.
    ...
    * [`ReconfigureFundingCycles`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/reconfigurefundingcycles.md)
...
| Name                                                                    | Data                                                                                                                                                                                                                                                                                                                                                          |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`ReconfigureFundingCycles`**](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/reconfigurefundingcycles.md)                                         | <ul><li><code>uint256 configuration</code></li><li><code>uint256 projectId</code></li><li><code>string memo</code></li><li><code>address caller</code></li></ul>                 |
