...
* Arguments:
  ...
  * `_fundingCycle` is the [`JBFundingCycle`](/docs/dev/v3/api/data-structures/jbfundingcycle.md) to base the token distribution on.
...
3.  Get a reference to reserved token splits for the current funding cycle configuration of the project.
    ...
    * [`splitsStore`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/properties/splitsstore.md)
...
4.  Loop through each split.
    ...
    7.  Emit a `DistributeToReservedTokenSplit` event for the split being iterated on with the relevant parameters.
        ...
        * [`DistributeToReservedTokenSplit`](/docs/dev/v3/deprecated/or-controllers/jbcontroller/events/distributetoreservedtokensplit.md)
