...
* The function returns:
  ...
  * `overflowAllowanceCurrency` is the currency from [`JBCurrencies`](/docs/dev/v3/api/libraries/jbcurrencies.md) that the returned overflow allowance is in terms of.
