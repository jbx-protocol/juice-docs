...
1.  Get the latest configured funding cycle and its ballot state.
    ...
    * [`latestConfiguredOf`](/docs/dev/v3/api/contracts/jbfundingcyclestore/read/latestconfiguredof.md)
2.  Expand the metadata of the funding cycle.
    ...
    * [`JBFundingCycleMetadataResolver`](/docs/dev/v3/api/libraries/jbfundingcyclemetadataresolver.md)<br/>
      * `.expandMetadata(...)`
