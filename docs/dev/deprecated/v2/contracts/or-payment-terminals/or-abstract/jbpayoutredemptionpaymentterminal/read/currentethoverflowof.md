...
1.  Get this terminal's current overflow, which is in terms of this terminal's token.
    ...
    * [`currentOverflowOf`](/dev/deprecated/v2/contracts/jbsingletokenpaymentterminalstore/read/currentoverflowof.md)
...
3.  If this terminal's currency isn't ETH, convert the overflow to ETH. Return the 18 decimal ETH fixed point overflow value.
    ...
    * [`prices`](/dev/deprecated/v2/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/properties/prices.md)
