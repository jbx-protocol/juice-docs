...
1.  Make sure the proposed fee is less than the max fee.
    ...
    * [`_FEE_CAP`](/dev/deprecated/v2/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/properties/-_fee_cap.md)
2.  Store the new fee.
...
3.  Emit a `SetFee` event with the relevant parameters.
    ...
    * [`SetFee`](/dev/deprecated/v2/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/events/setfee.md)
