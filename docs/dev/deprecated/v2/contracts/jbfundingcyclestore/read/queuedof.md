...
* The function overrides a function definition from the [`IJBFundingCycleStore`](/dev/deprecated/v2/interfaces/README.md) interface.
* The function returns a [`JBFundingCycle`](/dev/deprecated/v2/data-structures/jbfundingcycle.md).
...
2.  Check to see if there's a standby funding cycle configuration.
    ...
    * [`_standbyOf`](/dev/deprecated/v2/contracts/jbfundingcyclestore/read/-_getstructfor.md)
