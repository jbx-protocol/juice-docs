...
* `_operatorData` is the [`JBOperatorData`](/dev/deprecated/v2/data-structures/jboperatordata.md) that specifies the params for the operator being set.
...
3.  Emit a `SetOperator` event with the relevant parameters.
     ...
     * [`SetOperator`](/dev/deprecated/v2/contracts/jboperatorstore/events/setoperator.md)
