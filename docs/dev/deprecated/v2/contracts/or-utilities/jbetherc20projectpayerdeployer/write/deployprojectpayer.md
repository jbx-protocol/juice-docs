...
Contract: [`JBETHERC20ProjectPayerDeployer`](/dev/deprecated/v2/contracts/or-utilities/jbetherc20projectpayerdeployer/README.md)

Interface: [`IJBETHERC20ProjectPayerDeployer`](/dev/deprecated/v2/interfaces/ijbetherc20projectpayerdeployer.md)
...
* The function overrides a function definition from the[`IJBETHERC20ProjectPayerDeployer`](/dev/deprecated/v2/interfaces/ijbetherc20projectpayerdeployer.md) interface.
...
1.  Deploy the project payer contract.
    ...
    * [`JBETHERC20ProjectPayer`](/dev/deprecated/v2/contracts/or-utilities/jbetherc20projectpayer)
2.  Emit a `DeployProjectPayer` event with all relevant parameters.
    ...
    * [`DeployProjectPayer`](/dev/deprecated/v2/contracts/or-utilities/jbetherc20projectpayerdeployer/events/deployprojectpayer.md)
