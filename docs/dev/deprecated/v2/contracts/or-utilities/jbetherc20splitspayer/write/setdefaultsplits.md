...
* The function overrides a function definition from the [`IJBSplitsPayer`](/dev/deprecated/v2/interfaces/ijbsplitspayer.md) interface.
...
6.  Emit a `SetDefaultSplits` event with all relevant parameters.
    ...
    * [`SetDefaultSplits`](/dev/deprecated/v2/contracts/or-utilities/jbetherc20splitspayer/events/setdefaultsplits.md)
