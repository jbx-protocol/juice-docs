...
5.  Set the default metadata if it has changed.
    ...
    * [`defaultPreferAddToBalance`](/dev/deprecated/v2/contracts/or-utilities/jbetherc20projectpayer/properties/defaultpreferaddtobalance.md)
6.  Emit a `SetDefaultValues` event with all relevant parameters.
    ...
    * [`SetDefaultValues`](/dev/deprecated/v2/contracts/or-utilities/jbetherc20projectpayer/events/setdefaultvalues.md)
