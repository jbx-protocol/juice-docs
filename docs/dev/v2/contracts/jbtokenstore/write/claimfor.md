...
* Through the [`requirePermission`](/docs/dev/v2/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the token holder, or from an operator that has been given the [`JBOperations.CLAIM`](/docs/dev/v2/libraries/jboperations.md) permission by the token holder.
...
3.  Get a reference to the amount of unclaimed project tokens the holder has.
    ...
    * [`unclaimedBalanceOf`](/docs/dev/v2/contracts/jbtokenstore/properties/unclaimedbalanceof.md)
...
6.  Subtract from the unclaimed token total supply of the project.
    ...
    * [`unclaimedTotalSupplyOf`](/docs/dev/v2/contracts/jbtokenstore/properties/unclaimedtotalsupplyof.md)
7.  Mint the tokens to the holder's wallet.
    ...
    * [`mint`](/docs/dev/v2/contracts/jbtoken/write/mint.md)
8.  Emit a `Claim` event with the relevant parameters.
    ...
    * [`Claim`](/docs/dev/v2/contracts/jbtokenstore/events/claim.md)
