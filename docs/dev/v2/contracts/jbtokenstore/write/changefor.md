...
_This contract must have access to all of the token's [`IJBToken`](/docs/dev/v2/interfaces/ijbtoken.md) interface functions._
...
3.  Make sure the token has 18 decimals.
    ...
    * [`decimals`](/docs/dev/v2/interfaces/ijbtoken.md)
...
8.  If there's a current token and a new owner address was provided, transfer the ownership of the current token from this contract to the new owner.
    ...
    * [`transferOwnership`](/docs/dev/v2/contracts/jbtoken/write/transferownership.md)
9.  Emit a `Change` event with the relevant parameters.
    ...
    * [`Change`](/docs/dev/v2/contracts/jbtokenstore/events/change.md)
