...
1.  Get a reference to all of the project's current terminals.
    ...
    * [`terminalsOf`](/docs/dev/v2/contracts/jbdirectory/read/terminalsof.md)
...
3.  For each terminal, add its balance in terms of ETH to the total ETH balance.
    ...
    * [`currentEthOverflowOf`](/docs/dev/v2/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/read/currentethoverflowof.md)
