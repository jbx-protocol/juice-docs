...
* Arguments:
  * `_baseFundingCycle` is The [`JBFundingCycle`](/docs/dev/v2/data-structures/jbfundingcycle.md) to base the calculation on.
...
1.  If the base funding cycle has no duration, the derived weight should be calculated from it no matter how much time has passed since it was active. The discount rate property in a [`JBFundingCycle`](/docs/dev/v2/data-structures/jbfundingcycle.md) is out of [`JBConstants.MAX_DISCOUNT_RATE`](/docs/dev/v2/libraries/jbconstants.md).
