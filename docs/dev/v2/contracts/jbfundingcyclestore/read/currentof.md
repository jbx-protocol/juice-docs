...
* The function returns the project's current [`JBFundingCycle`](/docs/dev/v2/data-structures/jbfundingcycle.md).
...
2.  Get a reference to the configuration of an eligible funding cycle if there is one. This eligible cycle might not yet be approved.
    ...
    * [`_eligibleOf`](/docs/dev/v2/contracts/jbfundingcyclestore/read/-_eligibleof.md)
