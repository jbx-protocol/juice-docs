...
* Arguments:
  ...
  * `_data` is the [`JBFundingCycleData`](/docs/dev/v2/data-structures/jbfundingcycledata.md) for the configuration.
...
* Returns the [`JBFundingCycle`](/docs/dev/v2/data-structures/jbfundingcycle.md) that the configuration will take effect during..
...
5.  Configure the intrinsic properties. This'll create a new funding cycle if there isn't a queued one already.
    ...
    * [`_configureIntrinsicpropertiesFor`](/docs/dev/v2/contracts/jbfundingcyclestore/write/-_configureintrinsicpropertiesfor.md)
6.  Store all of the user configuration properties provided. These properties can all be packed into one `uint256` storage slot. No need to store if the resulting stored value would be 0 since the storage slot defaults to 0.
    ...
    * [`_packedUserPropertiesOf`](/docs/dev/v2/contracts/jbfundingcyclestore/properties/-_packeduserpropertiesof.md)
7.  Store the provided metadata for the configuration. No need to store if the value is 0 since the storage slot defaults to 0.
    ...
    * [`_metadataOf`](/docs/dev/v2/contracts/jbfundingcyclestore/properties/-_metadataof.md)
8.  Emit a `Configure` event with the relevant parameters.
    ...
    * [`Configure`](/docs/dev/v2/contracts/jbfundingcyclestore/events/configure.md)
9.  Return the [`JBFundingCycle`](/docs/dev/v2/data-structures/jbfundingcycle.md) struct that carries the new configuration.
