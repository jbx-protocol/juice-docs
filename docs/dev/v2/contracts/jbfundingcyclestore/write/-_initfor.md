...
1.  If no base funding cycle was provided, create a first funding cycle for the project by storing its intrinsic properties. Otherwise, create a new funding cycle by deriving values from the specified base cycle, interpreting a weight of 0 to inherit from the discounted weight of the base funding cycle and a weight of 1 as a weight of 0.
    ...
    * [`_packAndStoreIntrinsicPropertiesOf`](/docs/dev/v2/contracts/jbfundingcyclestore/write/-_packandstoreintrinsicpropertiesof.md)
    * [`_deriveStartFrom`](/docs/dev/v2/contracts/jbfundingcyclestore/read/-_derivestartfrom.md)
    * [`_deriveWeightFrom`](/docs/dev/v2/contracts/jbfundingcyclestore/read/-_deriveweightfrom.md)
    * [`_deriveNumberFrom`](/docs/dev/v2/contracts/jbfundingcyclestore/read/-_derivenumberfrom.md)
...
3.  Emit an `Init` event with the relevant parameters.
    ...
    * [`Init`](/docs/dev/v2/contracts/jbfundingcyclestore/events/init.md)
