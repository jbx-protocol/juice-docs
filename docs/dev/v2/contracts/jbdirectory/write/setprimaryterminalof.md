...
* Through the [`requirePermission`](/docs/dev/v2/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the project's owner, or from an operator that has been given the [`JBOperations.SET_PRIMARY_TERMINAL`](/docs/dev/v2/libraries/jboperations.md) permission by the project owner for the provided `_projectId`.
...
2.  Make sure the project's current funding cycle is set to allow setting terminals, or the request to set the terminals is coming from the project's current controller.
    ...
    * [`_addTerminalIfNeeded`](/docs/dev/v2/contracts/jbdirectory/write/-_addterminalifneeded.md)
...
4.  Emit a `SetPrimaryTerminal` event with the relevant parameters.
    ...
    * [`SetPrimaryTerminal`](/docs/dev/v2/contracts/jbdirectory/events/setprimaryterminal.md)
