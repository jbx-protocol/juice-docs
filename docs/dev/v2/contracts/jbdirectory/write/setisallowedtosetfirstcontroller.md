...
1.  Set the allowlist property for the provided address to the flag's value.
    ...
    * [`isAllowedToSetFirstController`](/docs/dev/v2/contracts/jbdirectory/properties/isallowedtosetfirstcontroller.md)
2.  Emit a `SetIsAllowedToSetFirstController` event with the relevant parameters.
    ...
    * [`SetIsAllowedToSetFirstController`](/docs/dev/v2/contracts/jbdirectory/events/setisallowedtosetfirstcontroller.md)
