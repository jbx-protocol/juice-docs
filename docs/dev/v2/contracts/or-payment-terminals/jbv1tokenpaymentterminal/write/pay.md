...
* Through the [`isTerminalOf`](/docs/dev/v2/contracts/or-payment-terminals/jbv1tokenpaymentterminal/modifiers/isterminalof.md) modifier, this transaction reverts if this terminal is not one of the project's terminals.
...
1.  Make sure the project owner hasn't finalized exchanges yet.
    ...
    * [`finalized`](/docs/dev/v2/contracts/or-payment-terminals/jbv1tokenpaymentterminal/properties/finalized.md)
...
4.  Forward the call to the internal version of the function.
    ...
    * [`_pay`](/docs/dev/v2/contracts/or-payment-terminals/jbv1tokenpaymentterminal/write/-_pay.md)
