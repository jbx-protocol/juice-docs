...
1.  Record the use of the allowed funds.
    ...
    * [`recordUsedAllowanceOf`](/docs/dev/v2/contracts/jbsingletokenpaymentterminalstore/write/recordusedallowanceof.md)
...
3.  The following scoped block is a bit of a hack to prevent a "Stack too deep" error.
    ...
    2.  Get a reference to the project owner, who will be the beneficiary of the paid fee.
        ...
        * [`projects`](/docs/dev/v2/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/properties/projects.md)
...
4.  Emit a `UseAllowance` event with the relevant parameters.
    ...
    * [`UseAllowance`](/docs/dev/v2/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/events/useallowance.md)
