...
* Arguments:
  ...
  * `_fundingCycle` is the [`JBFundingCycle`](/docs/dev/v2/data-structures/jbfundingcycle.md) to base the token distribution on.
...
2.  Get a reference to reserved token splits for the current funding cycle configuration of the project.
    ...
    * [`splitsStore`](/docs/dev/v2/contracts/or-controllers/jbcontroller/properties/splitsstore.md)
...
7.  Emit a `DistributeToReservedTokenSplit` event for the split being iterated on with the relevant parameters.
    ...
    * [`DistributeToReservedTokenSplit`](/docs/dev/v2/contracts/or-controllers/jbcontroller/events/distributetoreservedtokensplit.md)
