...
* `_terminal` is the [`IJBPaymentTerminal`](/docs/dev/v2/interfaces/ijbpaymentterminal.md) managing the overflow.
...
* The function returns:
  ...
  * `overflowAllowanceCurrency` is the currency from [`JBCurrencies`](/docs/dev/v2/libraries/jbcurrencies.md) that the returned overflow allowance is in terms of.
