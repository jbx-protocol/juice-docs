...
* `_terminal` is the [`IJBPaymentTerminal`](/docs/dev/v2/interfaces/ijbpaymentterminal.md) from which distributions are being limited.
...
* The function returns:
  ...
  * `distributionLimitCurrency` is the currency from [`JBCurrencies`](/docs/dev/v2/libraries/jbcurrencies.md) that the returned distribution limit is in terms of.
