...
Contract: [`JBETHERC20ProjectPayerDeployer`](/docs/dev/v2/contracts/or-utilities/jbetherc20projectpayerdeployer/README.md)

Interface: [`IJBETHERC20ProjectPayerDeployer`](/docs/dev/v2/interfaces/ijbetherc20projectpayerdeployer.md)
...
* The function overrides a function definition from the[`IJBETHERC20ProjectPayerDeployer`](/docs/dev/v2/interfaces/ijbetherc20projectpayerdeployer.md) interface.
...
1.  Deploy the project payer contract.
    ...
    * [`JBETHERC20ProjectPayer`](/docs/dev/v2/contracts/or-utilities/jbetherc20projectpayer/README.md)
2.  Emit a `DeployProjectPayer` event with all relevant parameters.
    ...
    * [`DeployProjectPayer`](/docs/dev/v2/contracts/or-utilities/jbetherc20projectpayerdeployer/events/deployprojectpayer.md)
