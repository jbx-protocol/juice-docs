...
* [`deployProjectPayer`](/docs/dev/v2/contracts/or-utilities/jbetherc20projectpayerdeployer/write/deployprojectpayer.md)
...
* `directory` is the [`IJBDirectory`](/docs/dev/v2/interfaces/ijbdirectory.md) contract storing directories of terminals and controllers for each project.
