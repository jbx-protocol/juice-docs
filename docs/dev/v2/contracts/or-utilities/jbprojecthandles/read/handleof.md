...
3.  Get the projectId stored in the TEXT record of the ENS node of the stored ENS name.
    ...
    * [`textResolver`](/docs/dev/v2/contracts/or-utilities/jbprojecthandles/properties/textresolver.md)
    * [`TEXT_KEY`](/docs/dev/v2/contracts/or-utilities/jbprojecthandles/properties/textkey.md)
    * [`_namehash`](/docs/dev/v2/contracts/or-utilities/jbprojecthandles/read/-_namehash.md)
...
5.  Return a handle formatted from the stored ENS name parts.
    ...
    * [`_formatHandle`](/docs/dev/v2/contracts/or-utilities/jbprojecthandles/read/-_formathandle.md)
