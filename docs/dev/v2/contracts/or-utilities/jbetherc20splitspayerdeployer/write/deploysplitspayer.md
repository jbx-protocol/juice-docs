...
Contract: [`JBETHERC20SplitsPayerDeployer`](/docs/dev/v2/contracts/or-utilities/jbetherc20splitspayerdeployer/README.md)

Interface: [`IJBETHERC20SplitsPayerDeployer`](/docs/dev/v2/interfaces/ijbetherc20splitspayerdeployer.md)
...
* The function overrides a function definition from the[`IJBETHERC20SplitsPayerDeployer`](/docs/dev/v2/interfaces/ijbetherc20splitspayerdeployer.md) interface.
...
1.  Deploy the splits payer contract.
    ...
    * [`JBETHERC20SplitsPayer`](/docs/dev/v2/contracts/or-utilities/jbetherc20splitspayer/README.md)
2.  Emit a `DeploySplitsPayer` event with all relevant parameters.
    ...
    * [`DeploySplitsPayer`](/docs/dev/v2/contracts/or-utilities/jbetherc20splitspayerdeployer/events/deploysplitspayer.md)
