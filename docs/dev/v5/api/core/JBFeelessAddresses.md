...
**Inherits:**
Ownable, [IJBFeelessAddresses](/docs/dev/v5/api/core/interfaces/IJBFeelessAddresses.md), IERC165
...
*See [IERC165-supportsInterface](/docs/dev/v5/api/core/JBDeadline.md#supportsinterface).*
