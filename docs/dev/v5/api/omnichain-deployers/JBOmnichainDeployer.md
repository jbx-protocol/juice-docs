# JBOmnichainDeployer
[Git Source](https://github.com/Bananapus/nana-omnichain-deployers/blob/42d39e1442cba9e916ad812112755629711fb759/src/JBOmnichainDeployer.sol)

**Inherits:**
ERC2771Context, JBPermissioned, [IJBOmnichainDeployer](/docs/dev/v5/api/omnichain-deployers/interfaces/IJBOmnichainDeployer.md), IJBRulesetDataHook, IERC721Receiver
...
|`dataHook`|`IJBRulesetDataHook`|The data hook.|
