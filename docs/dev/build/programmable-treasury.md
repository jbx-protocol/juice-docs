...
* Meanwhile, all of the project's funds in the [`JBPayoutRedemptionPaymentTerminal3_1`](/dev/api/contracts/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal3_1/) are considered overflow since there is no distribution limit.
