...
**Inherits:**
ERC721, Ownable, [IJBProjects](/docs/dev/v4/api/core/interfaces/IJBProjects.md)
...
*See [IERC165-supportsInterface](/docs/dev/v4/api/core/JBFeelessAddresses.md#supportsinterface).*
