...
**Inherits:**
[JBPermissioned](/docs/dev/v4/api/core/abstract/JBPermissioned.md), ERC2771Context, [IJBMultiTerminal](/docs/dev/v4/api/core/interfaces/IJBMultiTerminal.md)
...
*See [IERC165-supportsInterface](/docs/dev/v4/api/core/JBController.md#supportsinterface).*
