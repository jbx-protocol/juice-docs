...
To resolve this, the multisig should transfer 1.89132282774380456 ETH[^1] to [@juicebox](https://juicebox.money/@juicebox) and transfer 0.29048717225619544 ETH[^2] to [@wagmi-studios](https://juicebox.money/@wagmi-studios). WAGMI should burn 7,945.17866662079595157101 JBX[^3] received through relevant fees.
