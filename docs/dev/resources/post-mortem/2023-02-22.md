...
To resolve this, the multisig should transfer 1.89132282774380456 ETH to [@juicebox](https://juicebox.money/@juicebox) and transfer 0.29048717225619544 ETH to [@wagmi-studios](https://juicebox.money/@wagmi-studios). WAGMI should burn the JBX received through fees (calculations coming shortly).
