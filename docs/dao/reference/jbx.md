...
Juicebox projects pay a 2.5% fee when they pay a wallet outside of the Juicebox ecosystem or when funds are redeemed while the redemption rate is less than 100%. To be clear:

- There are no fees when projects receive payments.
- There are no fees on redemptions if the redemption rate is 100%.
- There are no fees on payouts to another Juicebox project.
