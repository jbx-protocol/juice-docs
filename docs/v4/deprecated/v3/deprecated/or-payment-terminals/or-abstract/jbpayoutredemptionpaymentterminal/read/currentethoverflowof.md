...
1.  Get this terminal's current overflow, which is in terms of this terminal's token.
    ...
    * [`currentOverflowOf`](/v4/deprecated/v3/deprecated/jbsingletokenpaymentterminalstore/read/currentoverflowof.md)
...
3.  If this terminal's currency isn't ETH, convert the overflow to ETH. Return the 18 decimal ETH fixed point overflow value.
    ...
    * [`JBCurrencies`](/v4/deprecated/v3/api/libraries/jbcurrencies.md)
      * `.ETH`
    ...
    * [`prices`](/v4/deprecated/v3/deprecated/or-payment-terminals/or-abstract/jbpayoutredemptionpaymentterminal/properties/prices.md)
