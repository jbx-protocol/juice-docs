...
* `_terminal` is the [`IJBPaymentTerminal`](/docs/v4/deprecated/v3/api/interfaces/ijbpaymentterminal.md) managing the overflow.
...
* The function returns:
  ...
  * `overflowAllowanceCurrency` is the currency from [`JBCurrencies`](/docs/v4/deprecated/v3/api/libraries/jbcurrencies.md) that the returned overflow allowance is in terms of.
