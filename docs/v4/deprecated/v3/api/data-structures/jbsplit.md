...
https://github.com/jbx-protocol/juice-contracts-v3/blob/main/contracts/structs/JBSplit.sol
...
* `percent` is the percent of the whole group that this split occupies. This number is out of [`JBConstants.SPLITS_TOTAL_PERCENT`](/docs/v4/deprecated/v3/api/libraries/jbconstants.md).
