...
|Name|Type|Description|
|----|----|-----------|
|`_feeGauge`|[`IJBFeeGauge`](/docs/v4/deprecated/v3/api/interfaces/ijbfeegauge.md)|The new fee gauge.|
...
|`_fundingCycle`|[`JBFundingCycle`](/docs/v4/deprecated/v3/api/data-structures/jbfundingcycle.md)|The funding cycle during which the fee is being taken.|
