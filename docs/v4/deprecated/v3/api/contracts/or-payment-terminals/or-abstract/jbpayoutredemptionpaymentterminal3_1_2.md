...
| Name     | Type                                         | Description                           |
| -------- | -------------------------------------------- | ------------------------------------- |
| `<none>` | [`JBFee[]`](/v4/deprecated/v3/api/data-structures/jbfee/) | An array of fees that are being held. |
...
| Name           | Type                                           | Description                                                                                                                 |
| -------------- | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `_split`       | [`JBSplit`](/v4/deprecated/v3/api/data-structures/jbsplit/) | The split to distribute payouts to.                                                                                         |
| `_projectId`   | `uint256`                                      |                                                                                                                             |
| `_group`       | `uint256`                                      |                                                                                                                             |
...
| `_feeType`   | [`JBFeeType`](/v4/deprecated/v3/api/enums/jbfeetype/) | The type of fee the discount is being applied to. |
