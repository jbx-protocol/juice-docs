...
1.  Make sure the v1 project and v2 project have the same owner.
    ...
    * [`projects`](/docs/v4/deprecated/v3/api/contracts/or-payment-terminals/jbv1tokenpaymentterminal/properties/projects.md)
...
3.  Emit a `SetV1ProjectId` event with the relevant parameters.
    ...
    * [`SetV1ProjectId`](/docs/v4/deprecated/v3/api/contracts/or-payment-terminals/jbv1tokenpaymentterminal/events/setv1projectid.md)
