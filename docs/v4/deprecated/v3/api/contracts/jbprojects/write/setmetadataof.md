...
* Through the [`requirePermission`](/v4/deprecated/v3/api/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the project's owner, or from an operator that has been given the [`JBOperations.SET_METADATA`](/v4/deprecated/v3/api/libraries/jboperations.md) permission by the project owner for the provided `_projectId`.
...
2.  Emit a `SetMetadataCid` event with the relevant parameters.
    ...
    * [`SetMetadata`](/v4/deprecated/v3/api/contracts/jbprojects/events/setmetadata.md)
