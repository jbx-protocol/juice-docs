...
* The function returns the project's current [`JBFundingCycle`](/v4/deprecated/v3/api/data-structures/jbfundingcycle.md).
...
2.  Get a reference to the configuration of an eligible funding cycle if there is one. This eligible cycle might not yet be approved.
    ...
    * [`_eligibleOf`](/v4/deprecated/v3/api/contracts/jbfundingcyclestore/read/-_eligibleof.md)
