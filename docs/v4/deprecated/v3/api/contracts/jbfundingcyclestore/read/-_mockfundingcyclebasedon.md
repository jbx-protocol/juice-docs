...
* Arguments:
  * `_baseFundingCycle` is the [`JBFundingCycle`](/docs/v4/deprecated/v3/api/data-structures/jbfundingcycle.md) that the resulting funding cycle should follow.
  * `_allowMidCycle` is a flag indicating if the mocked funding cycle is allowed to already be mid cycle.
* The view function is private to this contract.
* The view function does not alter state on the blockchain.
* The function returns a mock [`JBFundingCycle`](/docs/v4/deprecated/v3/api/data-structures/jbfundingcycle.md) of what the next funding cycle will be.
...
2.  Find the correct start time for the mock funding cycle.
    ...
    * [`_deriveStartFrom`](/docs/v4/deprecated/v3/api/contracts/jbfundingcyclestore/read/-_derivestartfrom.md)
3.  Find the correct number for the mock funding cycle.
    ...
    * [`_deriveNumberFrom`](/docs/v4/deprecated/v3/api/contracts/jbfundingcyclestore/read/-_derivenumberfrom.md)
4.  Return a [`JBFundingCycle`](/docs/v4/deprecated/v3/api/data-structures/jbfundingcycle.md) with the aggregated configuration.
    ...
    * [`_deriveWeightFrom`](/docs/v4/deprecated/v3/api/contracts/jbfundingcyclestore/read/-_deriveweightfrom.md)
