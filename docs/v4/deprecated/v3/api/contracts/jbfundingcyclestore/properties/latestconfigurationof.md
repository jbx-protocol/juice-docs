...
* The resulting function overrides a function definition from the [`IJBFundingCycleStore`](/v4/deprecated/v3/api/interfaces/ijbfundingcyclestore.md) interface.
