...
Inherit from `JuiceboxProject` in your contract. You will need to provide a `Project ID` and [`Terminal Directory`](/v4/deprecated/v1/terminal-directory.md) address to the `JuiceboxProject` constructor.
