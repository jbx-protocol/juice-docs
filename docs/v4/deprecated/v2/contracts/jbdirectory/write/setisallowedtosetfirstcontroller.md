...
1.  Set the allowlist property for the provided address to the flag's value.
    ...
    * [`isAllowedToSetFirstController`](/v4/deprecated/v2/contracts/jbdirectory/properties/isallowedtosetfirstcontroller.md)
2.  Emit a `SetIsAllowedToSetFirstController` event with the relevant parameters.
    ...
    * [`SetIsAllowedToSetFirstController`](/v4/deprecated/v2/contracts/jbdirectory/events/setisallowedtosetfirstcontroller.md)
