...
3.  Get a reference to the current amount of reserved tokens given the current state of the tracker, the current funding cycle's reserved rate, and the current total token supply.
    ...
    * [`_reservedTokenAmountFrom`](/docs/v4/deprecated/v2/contracts/or-controllers/jbcontroller/read/-_reservedtokenamountfrom.md)
...
6.  If there are outstanding reserved tokens, distribute them to reserved token splits. Get a reference to any leftover amount after the splits are settled.
    ...
    * [`JBSplitsGroups`](/docs/v4/deprecated/v2/libraries/jbsplitsgroups.md)
      * `.RESERVED_TOKENS`

    _Internal references:_

    * [`_distributeToReservedTokenSplitsOf`](/docs/v4/deprecated/v2/contracts/or-controllers/jbcontroller/write/-_distributetoreservedtokensplitsof.md)
...
8.  Emit a `DistributeReservedTokens` event with the relevant parameters.
    ...
    * [`DistributeReservedTokens`](/docs/v4/deprecated/v2/contracts/or-controllers/jbcontroller/events/distributereservedtokens.md)
