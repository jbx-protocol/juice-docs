...
3.  Emit a `PrepMigration` event with the relevant parameters.
    ...
    * [`PrepMigration`](/v4/deprecated/v2/contracts/or-controllers/jbcontroller/events/prepmigration.md)
...
| Name                                        | Data                                                                                                                                                                                                                                                       |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**`PrepMigration`**](/v4/deprecated/v2/contracts/or-controllers/jbcontroller/events/prepmigration.md)                                               | <ul><li><code>uint256 projectId</code></li><li><code>[IJBController](/v4/deprecated/v2/interfaces/ijbcontroller.md) from</code></li><li><code>address caller</code></li></ul>                                                                                                                  |
