...
* Through the [`requirePermission`](/docs/v4/deprecated/v2/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the project's owner, or from an operator that has been given the [`JBOperations.RECONFIGURE`](/docs/v4/deprecated/v2/libraries/jboperations.md) permission by the project owner for the provided `_projectId`.
...
5.  Emit a `LaunchFundingCycles` event with the relevant parameters.
    ...
    * [`LaunchFundingCycles`](/docs/v4/deprecated/v2/contracts/or-controllers/jbcontroller/events/launchfundingcycles.md)
