...
1.  Get the latest configured funding cycle and its ballot state.
    ...
    * [`latestConfiguredOf`](/v4/deprecated/v2/contracts/jbfundingcyclestore/read/latestconfiguredof.md)
2.  Expand the metadata of the funding cycle.
    ...
    * [`JBFundingCycleMetadataResolver`](/v4/deprecated/v2/libraries/jbfundingcyclemetadataresolver.md)<br/>
      * `.expandMetadata(...)`
