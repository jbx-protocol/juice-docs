...
* Through the [`requirePermission`](/v4/deprecated/v2/contracts/or-abstract/jboperatable/modifiers/requirepermission.md) modifier, the function is only accessible by the token holder, or from an operator that has been given the [`JBOperations.TRANSFER`](/v4/deprecated/v2/libraries/jboperations.md) permission by the token holder.
...
6.  Emit a `Transfer` event with the relevant parameters.
    ...
    * [`Transfer`](/v4/deprecated/v2/contracts/jbtokenstore/events/transfer.md)
