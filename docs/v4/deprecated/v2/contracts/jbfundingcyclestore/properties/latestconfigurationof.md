...
* The resulting function overrides a function definition from the [`IJBFundingCycleStore`](/docs/v4/deprecated/v2/interfaces/ijbfundingcyclestore.md) interface.
