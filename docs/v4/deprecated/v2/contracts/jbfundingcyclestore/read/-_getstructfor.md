...
* The function returns a [`JBFundingCycle`](/docs/v4/deprecated/v2/data-structures/jbfundingcycle.md) struct.
...
3.  Get the stored intrinsic properties of the funding cycle. Populate the struct values by unpacking the `uint256`.
    ...
    * [`_packedIntrinsicPropertiesOf`](/docs/v4/deprecated/v2/contracts/jbfundingcyclestore/properties/-_packedintrinsicpropertiesof.md)
