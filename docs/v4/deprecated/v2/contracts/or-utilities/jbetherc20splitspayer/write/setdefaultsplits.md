...
* The function overrides a function definition from the [`IJBSplitsPayer`](/docs/v4/deprecated/v2/interfaces/ijbsplitspayer.md) interface.
...
6.  Emit a `SetDefaultSplits` event with all relevant parameters.
    ...
    * [`SetDefaultSplits`](/docs/v4/deprecated/v2/contracts/or-utilities/jbetherc20splitspayer/events/setdefaultsplits.md)
