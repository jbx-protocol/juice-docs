...
* The function overrides a function definition from the [`IJBProjectHandles`](/docs/v4/deprecated/v2/interfaces/ijbprojecthandles.md) interface.
...
3.  Get the projectId stored in the TEXT record of the ENS node of the stored ENS name.
    ...
    * [`textResolver`](/docs/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/properties/textresolver.md)
    * [`TEXT_KEY`](/docs/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/properties/textkey.md)
    * [`_namehash`](/docs/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/read/-_namehash.md)
...
5.  Return a handle formatted from the stored ENS name parts.
    ...
    * [`_formatHandle`](/docs/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/read/-_formathandle.md)
