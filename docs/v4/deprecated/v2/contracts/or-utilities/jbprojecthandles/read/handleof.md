...
3.  Get the projectId stored in the TEXT record of the ENS node of the stored ENS name.
    ...
    * [`textResolver`](/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/properties/textresolver.md)
    * [`TEXT_KEY`](/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/properties/textkey.md)
    * [`_namehash`](/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/read/-_namehash.md)
...
5.  Return a handle formatted from the stored ENS name parts.
    ...
    * [`_formatHandle`](/v4/deprecated/v2/contracts/or-utilities/jbprojecthandles/read/-_formathandle.md)
