...
* `reclaimedAmount` is the [`JBTokenAmount`](/docs/v4/deprecated/v2/data-structures/jbtokenamount.md) reclaimed from the treasury. Includes the token being reclaimed, the value, the number of decimals included, and the currency of the amount.
