...
* `percent` is the percent of the whole group that this split occupies. This number is out of [`JBConstants.SPLITS_TOTAL_PERCENT`](/docs/v4/deprecated/v2/libraries/jbconstants.md).
