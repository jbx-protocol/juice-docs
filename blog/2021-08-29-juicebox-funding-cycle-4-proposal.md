...
- One low severity bug was discovered, an explanation of what happened can be found [here](/dev/resources/post-mortem/2021-08-18/), and a postmortem is available [here](https://github.com/jbx-protocol/juice-security/blob/main/incidents/08-18-2021.md).
