...
- One low severity bug was discovered, an explanation of what happened can be found [here](/docs/v4/deprecated/v3/resources/post-mortem/2021-08-18/README.md), and a postmortem is available [here](https://github.com/jbx-protocol/juice-security/blob/main/incidents/08-18-2021.md).
