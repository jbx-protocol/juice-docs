...
我们都知道，每个进入我们多为的 ETH，DAO 将按照其发行价格铸造新的 JBX 并发行给那些支付费用或点击支付按钮的人。我们也知道，在公开市场（如 Uniswap）上有人愿意以不同的价格出售 JBX。

因此，在开放市场价格低于我们的发行价格的情况下，回购委托将提议 DAO 放弃将 ETH 存入金库，而是将 ETH 中转到交易市场，以确保向我们金库付款的人都可以尽可能多地获得 JBX 代币。
