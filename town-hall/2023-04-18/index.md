...
There're a few improvements to the current [`JBTiered721Delegate`](https://docs.juicebox.money/dev/v3/extensions/juice-721-delegate/README.md/contracts/jbtiered721delegate) that have been queued for a new version.
